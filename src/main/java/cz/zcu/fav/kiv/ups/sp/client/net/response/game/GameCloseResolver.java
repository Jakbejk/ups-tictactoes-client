 ...
 * @project UPS-client
 */
public class GameCloseResolver implements IResolver {
    ...
    public void resolve(ResponseMessage responseMessage) throws InvalidResponseException {
        logger.debug("GAME_CLOSE request: " + responseMessage + " received.");

        if (responseMessage.getResponse() == ResponsePrefix.OK) {
            ControllerManager.changeTo(ControllerType.LOBBY);
